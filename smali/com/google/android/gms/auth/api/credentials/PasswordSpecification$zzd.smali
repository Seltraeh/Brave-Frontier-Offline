...
.method private static zzd(Ljava/lang/String;Ljava/lang/String;)Ljava/util/TreeSet;
    ...
    invoke-static {v3, v4, v5}, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;->zze(III)Z
    ...
    :cond_0
    new-instance p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zze;
    ...
    invoke-direct {p0, p1}, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zze;-><init>(Ljava/lang/String;)V
...
.method public final zzd(II)Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zzd;
    ...
    iput p1, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zzd;->zzdl:I

    const/16 p1, 0x10

    iput p1, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zzd;->zzdm:I
...
.method public final zzd(Ljava/lang/String;I)Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zzd;
    ...
    invoke-static {p1, p2}, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zzd;->zzd(Ljava/lang/String;Ljava/lang/String;)Ljava/util/TreeSet;

    move-result-object p1

    iget-object p2, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zzd;->zzdj:Ljava/util/List;

    invoke-static {p1}, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;->zze(Ljava/util/Collection;)Ljava/lang/String;

    move-result-object p1

    invoke-interface {p2, p1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object p1, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zzd;->zzdk:Ljava/util/List;
...
.method public final zzj()Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;
    ...
    iget-object v4, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zzd;->zzdj:Ljava/util/List;

    iget-object v5, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zzd;->zzdk:Ljava/util/List;

    iget v6, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zzd;->zzdl:I

    iget v7, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zzd;->zzdm:I
